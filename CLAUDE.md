...
7. **Zero client-side JavaScript on content pages.** Everything SEO/rendering is build-time. Pagefind's JS on search interaction is the only exception. No analytics scripts, no islands, no client data fetching. (SEO §6)
